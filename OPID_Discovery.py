...
def discover_opid(ocel, classification_data):
    ...
    for (many_type, one_type, activity_classification) in classification_data:
        object_type_pair = (many_type, one_type)

        for activity, classifications in activity_classification.items():
            # update the label of the activity by concatenating the first element of each classification list with underscores
    ...
    # Output to JSON
    output_path = "transformed_opid.json"
